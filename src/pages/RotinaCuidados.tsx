...
const sabonetes: RotinaSabonete[] = [
  ...
  {
    id: 2,
    nome: "Argila Verde e Azul",
    codigo: "SAB03",
    pasta: "argila_verde_azul",
    tagline: "Purifica a oleosidade e acalma a pele",
    descricao: "A argila verde é adstringente e antibacteriana: controla a oleosidade, desintoxica os poros e ajuda a prevenir a acne. Já a argila azul, rica em minerais, tem ação anti-inflamatória e calmante, aliviando vermelhidões e irritações. Juntas, purificam em profundidade enquanto equilibram e acalmam a pele.",
    frequencia: "2 a 3x por semana",
    passos: [
      "Aplique sobre a pele úmida em movimentos circulares",
      "Deixe agir de 2 a 3 minutos como máscara",
      "Enxágue com água morna e finalize com água fria para fechar os poros",
    ],
    resultado: "Oleosidade controlada, poros purificados e pele mais calma e equilibrada.",
  },
  {
    id: 3,
    nome: "Dolomita",
